...
import { h as httpGet, q as queryClient, b as httpDelete, a as httpPost } from './query-client_rwy39LWF.mjs';
import { e as userPersonaOptions, c as chatHistoryOptions, f as ChatHistory, P as PersonalizedResponseForm, h as renderMessage, R as RoadmapRecommendations, L as ListChatHistory, i as ChatHistoryError } from './ListChatHistory_CIsf3J9j.mjs';
/* empty css                            */
...
import { c as cn, i as isLoggedIn, M as Modal, r as removeAuthToken } from './BaseLayout_BrSKT5L_.mjs';
...
import { A as AITutorLayout, u as useClientMount } from './AITutorLayout_CJilm_5H.mjs';
import { C as CheckSubscriptionVerification } from './CheckSubscriptionVerification_DrySdgR7.mjs';
...
function AIChat(props) {
  ...
  const completeAIChat = async (messages, force = false) => {
    ...
    const response = await fetch(`${undefined                              }/v1-chat`, {
      method: "POST",
      headers: {
