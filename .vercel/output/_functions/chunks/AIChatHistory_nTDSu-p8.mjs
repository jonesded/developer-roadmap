...
import { h as httpGet, q as queryClient, b as httpDelete, a as httpPost } from './query-client_B4F1D3EC.mjs';
import { e as userPersonaOptions, c as chatHistoryOptions, f as ChatHistory, P as PersonalizedResponseForm, h as renderMessage, R as RoadmapRecommendations, L as ListChatHistory, i as ChatHistoryError } from './ListChatHistory_DlOCoRfC.mjs';
/* empty css                            */
...
import { c as cn, i as isLoggedIn, M as Modal, r as removeAuthToken } from './BaseLayout_C3JOBLhD.mjs';
...
import { A as AITutorLayout, u as useClientMount } from './AITutorLayout_DTqb4Lq4.mjs';
import { C as CheckSubscriptionVerification } from './CheckSubscriptionVerification_h4-ZR5FJ.mjs';
...
function AIChat(props) {
  ...
  const completeAIChat = async (messages, force = false) => {
    ...
    const response = await fetch(`${"https://api.roadmap.sh"}/v1-chat`, {
      method: "POST",
      headers: {
