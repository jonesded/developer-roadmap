...
import { h as httpGet, q as queryClient, b as httpDelete, a as httpPost } from './query-client_CBXGK_YM.mjs';
import { e as userPersonaOptions, c as chatHistoryOptions, f as ChatHistory, P as PersonalizedResponseForm, h as renderMessage, R as RoadmapRecommendations, L as ListChatHistory, i as ChatHistoryError } from './ListChatHistory_CWyDawkn.mjs';
/* empty css                            */
...
import { c as cn, i as isLoggedIn, M as Modal, r as removeAuthToken } from './BaseLayout_B-BXcELP.mjs';
...
import { A as AITutorLayout, u as useClientMount } from './AITutorLayout_Cb7hPswk.mjs';
import { C as CheckSubscriptionVerification } from './CheckSubscriptionVerification_BpAEoJpp.mjs';
...
function AIChat(props) {
  ...
  const completeAIChat = async (messages, force = false) => {
    ...
    const response = await fetch(`${"https://api.imoogleai.xyz"}/v1-chat`, {
      method: "POST",
      headers: {
