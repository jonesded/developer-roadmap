...
import { i as isLoggedIn, u as useOutsideClick, c as cn, b as getUrlParams } from './BaseLayout_DfQviQZ5.mjs';
import { g as getAiGuideOptions, a as aiGuideSuggestionsOptions } from './ai-guide_DcVwAuuo.mjs';
import { A as AITutorLayout } from './AITutorLayout_D2lYDCfF.mjs';
import { U as UpgradeAccountModal } from './UpgradeAccountModal_DhdxALHd.mjs';
import { u as useChat } from './use-chat_BSWX1P-C.mjs';
import { a as RoadmapAIChatCard } from './UpdatePersonaModal_BaDdJAFo.mjs';
import { C as ChatHeaderButton } from './RoadmapFloatingChat_Z9uxEJRH.mjs';
import { s as showLoginPopup } from './popup_DWUkHIfQ.mjs';
import { b as billingDetailsOptions, u as useIsPaidUser } from './billing_B5wE6dhK.mjs';
  ...
  try {
    ...
    if (slug && isForce) {
      response = await fetch(
        `${"https://api.hnmdevs.com"}/v1-regenerate-ai-guide/${slug}`,
        {
          method: "POST",
          headers: {
      ...
      response = await fetch(
        `${"https://api.hnmdevs.com"}/v1-generate-ai-guide`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json"
...
function AIGuideChat(props) {
  ...
  const {
    ...
    endpoint: `${"https://api.hnmdevs.com"}/v1-ai-guide-chat`,
    onError: (error) => {
      console.error(error);
    },
    data: {
