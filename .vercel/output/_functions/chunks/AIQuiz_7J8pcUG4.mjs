...
import { c as cn, r as removeAuthToken, b as getUrlParams, i as isLoggedIn } from './BaseLayout_DfQviQZ5.mjs';
...
import { g as generateAIQuiz, a as aiQuizOptions } from './ai-quiz_0kia9WZf.mjs';
  ...
  const verifyAnswer = useCallback(async () => {
    try {
      ...
      const response = await fetch(
        `${"https://api.hnmdevs.com"}/v1-verify-quiz-answer/${quizSlug}`,
        {
          method: "POST",
          headers: {
