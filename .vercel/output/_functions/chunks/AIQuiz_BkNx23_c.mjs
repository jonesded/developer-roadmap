...
import { a as httpPost, q as queryClient } from './query-client_rwy39LWF.mjs';
...
import { c as cn, r as removeAuthToken, b as getUrlParams, i as isLoggedIn } from './BaseLayout_BrSKT5L_.mjs';
...
import { g as generateAIQuiz, a as aiQuizOptions } from './ai-quiz_DyI1q6Hv.mjs';
  ...
  const verifyAnswer = useCallback(async () => {
    try {
      ...
      const response = await fetch(
        `${undefined                              }/v1-verify-quiz-answer/${quizSlug}`,
        {
          method: "POST",
          headers: {
