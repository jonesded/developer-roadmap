...
import { a as httpPost, q as queryClient } from './query-client_CBXGK_YM.mjs';
...
import { c as cn, r as removeAuthToken, b as getUrlParams, i as isLoggedIn } from './BaseLayout_B-BXcELP.mjs';
...
import { g as generateAIQuiz, a as aiQuizOptions } from './ai-quiz_DJaw9bSw.mjs';
  ...
  const verifyAnswer = useCallback(async () => {
    try {
      ...
      const response = await fetch(
        `${"https://api.imoogleai.xyz"}/v1-verify-quiz-answer/${quizSlug}`,
        {
          method: "POST",
          headers: {
