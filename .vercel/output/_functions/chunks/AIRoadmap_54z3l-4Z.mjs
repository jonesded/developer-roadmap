...
import { a as aiRoadmapOptions, g as generateAIRoadmap } from './ai-roadmap_D_yuZb9_.mjs';
import { u as useOutsideClick, c as cn, i as isLoggedIn, b as getUrlParams } from './BaseLayout_BrSKT5L_.mjs';
...
function AIRoadmapChat(props) {
  ...
  const {
    ...
    endpoint: `${undefined                              }/v1-ai-roadmap-chat`,
    onError: (error) => {
      console.error(error);
