...
import { r as removeAuthToken, c as cn, i as isLoggedIn } from './BaseLayout_BrSKT5L_.mjs';
...
import { D as DropdownMenu, a as DropdownMenuTrigger, b as DropdownMenuContent, c as DropdownMenuItem, d as DropdownMenuSeparator } from './DropdownMenu_C_iIVsgK.mjs';
import { U as UpgradeSidebarCard } from './UpgradeSidebarCard_Co_EfIGj.mjs';
...
function UserDropdown(props) {
  ...
  const userAvatar = currentUser?.avatar ? `${undefined                                      }/${currentUser?.avatar}` : "/images/default-avatar.png";
