...
import { e as httpGet, i as isLoggedIn, j as $$AstroIcon } from './BaseLayout_C3JOBLhD.mjs';
import { T as TeamDropdown } from './TeamDropdown_qdEekB40.mjs';
...
function SidebarFriendsCounter() {
  ...
  async function getFriendCounts() {
    const { response, error } = await httpGet(
      `${"https://api.roadmap.sh"}/v1-get-friend-counts`
    );
    if (error || !response) {
      return;
    }
