...
import { e as httpGet, i as isLoggedIn, j as $$AstroIcon } from './BaseLayout_BrSKT5L_.mjs';
import { T as TeamDropdown } from './TeamDropdown_51bMongj.mjs';
...
function SidebarFriendsCounter() {
  ...
  async function getFriendCounts() {
    const { response, error } = await httpGet(
      `${undefined                              }/v1-get-friend-counts`
    );
    if (error || !response) {
      return;
    }
