...
import { c as cn, S as Spinner, e as httpGet, M as Modal, b as getUrlParams, p as pageProgressMessage, u as useOutsideClick, l as useKeydown, h as httpPost, g as getUser, R as RoadmapIcon, w as httpPut } from './BaseLayout_BrSKT5L_.mjs';
...
import { C as CreateRoadmapButton, F as FeaturedGuideList, a as FeaturedVideoList } from './CreateRoadmapButton_Dpb-tMYK.mjs';
import { C as CheckIcon } from './CheckIcon_B3c1RSNy.mjs';
import { g as getRelativeTimeString } from './date_iLNlXR7B.mjs';
import { M as MarkFavorite } from './MarkFavorite_D3-XYtD_.mjs';
...
import 'js-cookie';
import { P as Pagination } from './Pagination_P8BoyGfA.mjs';
...
function PersonalDashboard(props) {
  ...
  const avatarLink = avatar ? `${undefined                                      }/${avatar}` : "/images/default-avatar.png";
...
function TeamActivityItem(props) {
  ...
  const userAvatar = user.avatar ? `${undefined                                      }/${user.avatar}` : "/images/default-avatar.png";
...
function TeamActivityPage(props) {
  ...
  const getTeamProgress = async (currPage2 = 1) => {
    const { response, error } = await httpGet(
      `${undefined                              }/v1-get-team-activity/${teamId}`,
      {
        currPage: currPage2
      }
    );
...
function ResourceProgressActions(props) {
  ...
  async function clearProgress() {
    ...
    const { error, response } = await httpPost(
      `${undefined                              }/v1-clear-resource-progress`,
      {
        resourceId,
        resourceType
      }
...
function DashboardTeamRoadmaps(props) {
  ...
  async function onAdd(roadmapId, shouldCopyContent = false) {
    ...
    const { error, response } = await httpPut(
      `${undefined                              }/v1-update-team-resource-config/${teamId}`,
      {
        teamId,
  ...
  async function deleteResource(roadmapId) {
    ...
    const { error, response } = await httpPut(
      `${undefined                              }/v1-delete-team-resource-config/${teamId}`,
      {
        resourceId: roadmapId,
        resourceType: "roadmap"
      }
...
function InviteMemberPopup(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    const { response, error: error2 } = await httpPost(
      `${undefined                              }/v1-invite-member/${teamId}`,
...
function TeamDashboard(props) {
  ...
  async function getTeamProgress() {
    const { response, error } = await httpGet(
      `${undefined                              }/v1-get-team-progress/${teamId}`
    );
    if (error || !response) {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "mt-8", children: [
    ...
    !isLoading && /* @__PURE__ */ jsxs("div", { className: "mb-6 flex flex-wrap gap-2", children: [
      allMembersWithoutCurrentUser.map((member) => {
        const avatar = member?.avatar ? `${undefined                                      }/${member.avatar}` : "/images/default-avatar.png";
        return /* @__PURE__ */ jsxs(
          "a",
          {
...
function DashboardPage(props) {
  ...
  const userAvatar = currentUser?.avatar && !isLoading ? `${undefined                                      }/${currentUser.avatar}` : "/images/default-avatar.png";
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "bg-slate-800/30 py-5 min-h-[70px]", children: /* @__PURE__ */ jsx("div", { className: "container flex flex-wrap items-center gap-1.5", children: !isLoading && /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          teamList.map((team) => {
            const { avatar } = team;
            const avatarUrl = avatar ? `${undefined                                      }/${avatar}` : "/images/default-avatar.png";
            return /* @__PURE__ */ jsx(
              DashboardTabButton,
              {
                label: team.name,
