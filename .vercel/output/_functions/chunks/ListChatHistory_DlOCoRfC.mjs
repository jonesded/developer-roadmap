...
import { h as httpGet, q as queryClient, a as httpPost, b as httpDelete } from './query-client_B4F1D3EC.mjs';
import { c as cn, i as isLoggedIn, M as Modal, p as pageProgressMessage, r as removeAuthToken } from './BaseLayout_C3JOBLhD.mjs';
...
import { u as userResourceProgressOptions, r as roadmapTreeMappingOptions } from './roadmap-tree_DhFfmgQ6.mjs';
import { g as getPercentage } from './number_D9-I_I5P.mjs';
import { a as renderTopicProgress, u as updateResourceProgress } from './resource-progress_Dhi8X1Qg.mjs';
...
import { D as DropdownMenu, a as DropdownMenuTrigger, b as DropdownMenuContent, c as DropdownMenuItem } from './DropdownMenu_Ca8KYled.mjs';
import 'js-cookie';
  ...
  const completeAITutorChat = async (messages, abortController) => {
    try {
      const response = await fetch(
        `${"https://api.roadmap.sh"}/v1-chat-roadmap`,
        {
          method: "POST",
