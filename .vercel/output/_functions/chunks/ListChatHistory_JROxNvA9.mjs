...
import { h as httpGet, q as queryClient, a as httpPost, b as httpDelete } from './query-client_BnT_580V.mjs';
import { c as cn, i as isLoggedIn, M as Modal, p as pageProgressMessage, r as removeAuthToken } from './BaseLayout_DfQviQZ5.mjs';
...
import { u as userResourceProgressOptions, r as roadmapTreeMappingOptions } from './roadmap-tree_SwLtcRIZ.mjs';
import { g as getPercentage } from './number_D9-I_I5P.mjs';
import { a as renderTopicProgress, u as updateResourceProgress } from './resource-progress_JteJuO5t.mjs';
...
import { D as DropdownMenu, a as DropdownMenuTrigger, b as DropdownMenuContent, c as DropdownMenuItem } from './DropdownMenu_-ZOWibIC.mjs';
import 'js-cookie';
  ...
  const completeAITutorChat = async (messages, abortController) => {
    try {
      const response = await fetch(
        `${"https://api.hnmdevs.com"}/v1-chat-roadmap`,
        {
          method: "POST",
