...
import { c as cn, B as GitHubIcon, i as isLoggedIn, b as getUrlParams, E as COURSE_PURCHASE_PARAM, H as SAMPLE_AFTER_LOGIN_KEY, d as deleteUrlParam, I as COURSE_PURCHASE_SUCCESS_PARAM, J as CourseLoginPopup } from './BaseLayout_B-BXcELP.mjs';
import { R as RoadmapLogoIcon } from './RoadmapLogo_CqzCGDrz.mjs';
import { P as Popover, a as PopoverTrigger, b as PopoverContent } from './Popover_C-ZLwlkI.mjs';
import { useState, useEffect, useRef, useMemo, useLayoutEffect } from 'react';
import { V as VideoModal } from './VideoModal_CB0u1dGE.mjs';
import { queryOptions, useQuery, useMutation } from '@tanstack/react-query';
import { c as coursePriceOptions } from './billing_5mov2PsZ.mjs';
import { h as httpGet, q as queryClient, a as httpPost } from './query-client_CBXGK_YM.mjs';
import { u as useToast } from './use-toast_BYLkOsfO.mjs';
import { u as useCopyText } from './use-copy-text_Bqwbcq8G.mjs';
import { R as Rating } from './Rating_DHoReL0Z.mjs';
...
function BuyButton$1(props) {
  ...
  useEffect(() => {
    ...
    if (shouldTriggerSample) {
      ...
      window.location.href = `${"https://doc.imoogleai.xyz"}/${SQL_COURSE_SLUG$1}`;
...
function BuyButton(props) {
  ...
  useEffect(() => {
    ...
    if (shouldTriggerSample) {
      localStorage.removeItem(SAMPLE_AFTER_LOGIN_KEY);
      window.location.href = `${"https://doc.imoogleai.xyz"}/${SQL_COURSE_SLUG}`;
    } else if (shouldTriggerPurchase) {
      deleteUrlParam(COURSE_PURCHASE_PARAM);
      initPurchase();
    }
...
function AccountButton() {
  ...
  return /* @__PURE__ */ jsx(
    "a",
    {
      href: `${"https://doc.imoogleai.xyz"}/${SQL_COURSE_SLUG}`,
      className: `${buttonClasses} animate-fade-in`,
