...
import { c as cn, u as useOutsideClick, S as Spinner, e as httpGet } from './BaseLayout_BrSKT5L_.mjs';
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "mr-1.5 inline-grid grid-cols-[16px_auto] items-center gap-1.5", children: [
              ...
              !isLoading && /* @__PURE__ */ jsx(
                "img",
                {
                  src: selectedAvatar ? `${undefined                                      }/${selectedAvatar}` : "/images/default-avatar.png",
                  alt: "",
