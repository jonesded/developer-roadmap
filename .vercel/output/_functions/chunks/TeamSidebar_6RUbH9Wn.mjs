...
import { u as useOutsideClick, l as useKeydown, h as httpPost, G as GroupIcon } from './BaseLayout_B-BXcELP.mjs';
...
function SubmitFeedbackPopup(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    const { response, error: error2 } = await httpPost(
      `${"https://api.imoogleai.xyz"}/v1-submit-team-feedback/${teamId}`,
      {
