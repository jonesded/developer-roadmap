...
import { u as useOutsideClick, l as useKeydown, h as httpPost, G as GroupIcon } from './BaseLayout_C3JOBLhD.mjs';
...
function SubmitFeedbackPopup(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    const { response, error: error2 } = await httpPost(
      `${"https://api.roadmap.sh"}/v1-submit-team-feedback/${teamId}`,
      {
