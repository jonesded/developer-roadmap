...
import { c as cn, u as useOutsideClick, i as isLoggedIn, r as removeAuthToken, l as useKeydown, M as Modal, b as getUrlParams, S as Spinner, B as GitHubIcon, C as parseUrl, e as httpGet, p as pageProgressMessage } from './BaseLayout_BrSKT5L_.mjs';
import { g as getTopicStatus, u as updateResourceProgress, a as renderTopicProgress, b as refreshProgressCounters, i as isTopicDone } from './resource-progress_D7IfDnhr.mjs';
...
import { r as roadmapTreeMappingOptions, u as userResourceProgressOptions } from './roadmap-tree_DW8Rv0z5.mjs';
import { q as queryClient } from './query-client_rwy39LWF.mjs';
import { A as AIChatCard } from './AICourseLessonChat_GakhU-8L.mjs';
/* empty css                          */
  ...
  const completeAITutorChat = async (messages) => {
    try {
      ...
      const response = await fetch(
        `${undefined                              }/v1-topic-detail-chat`,
        {
          method: "POST",
          headers: {
