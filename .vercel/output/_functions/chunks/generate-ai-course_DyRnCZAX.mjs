...
import { u as useOutsideClick, i as isLoggedIn, c as cn, r as removeAuthToken, g as getUser, M as Modal } from './BaseLayout_DfQviQZ5.mjs';
import { u as useIsPaidUser, b as billingDetailsOptions } from './billing_B5wE6dhK.mjs';
...
import { q as queryClient, c as httpPatch, a as httpPost } from './query-client_BnT_580V.mjs';
import { s as slugify } from './slugger_ChlNJxtz.mjs';
import { g as getAiCourseOptions, a as aiLimitOptions } from './ai-course_ei-HsZ8o.mjs';
/* empty css                          */
import { M as ModifyCoursePrompt, U as UpdatePreferences } from './UpdatePreferences_CbjX1z_j.mjs';
import { s as showLoginPopup } from './popup_DWUkHIfQ.mjs';
import { R as ResizablePanelGroup, a as ResizablePanel, b as ResizableHandle, c as AICourseLessonChat } from './AICourseLessonChat_B-0UsG6B.mjs';
...
import { a as renderTopicProgress } from './resource-progress_JteJuO5t.mjs';
...
function TestMyKnowledgeAction(props) {
  ...
  const generateAiLessonQuestions = async () => {
    ...
    const response = await fetch(
      `${"https://api.hnmdevs.com"}/v1-generate-ai-course-lesson-question/${courseSlug}`,
      {
        method: "POST",
        headers: {
...
function AICourseLesson(props) {
  ...
  const generateAiCourseContent = async (isForce, customPrompt) => {
    ...
    const response = await fetch(
      `${"https://api.hnmdevs.com"}/v1-generate-ai-course-lesson/${courseSlug}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
...
function AICourseRoadmapView(props) {
  ...
  const generateAICourseRoadmap = async (courseSlug2) => {
    ...
    try {
      const response = await fetch(
        `${"https://api.hnmdevs.com"}/v1-generate-ai-course-roadmap/${courseSlug2}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json"
  ...
  const { mutate: forkCourse } = useMutation(
    {
      mutationFn: async () => {
        setIsPending(true);
        return httpPost(
          `${"https://api.hnmdevs.com"}/v1-fork-ai-course/${courseSlug}`,
          {}
        );
      },
      onSuccess(data) {
  ...
  try {
    ...
    if (slug && isForce) {
      response = await fetch(
        `${"https://api.hnmdevs.com"}/v1-regenerate-ai-course/${slug}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json"
      ...
      response = await fetch(
        `${"https://api.hnmdevs.com"}/v1-generate-ai-course`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json"
