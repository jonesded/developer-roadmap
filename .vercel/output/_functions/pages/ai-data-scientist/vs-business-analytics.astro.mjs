...
const $$VsBusinessAnalytics = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": guideData.seo.title, "description": guideData.seo.description, "permalink": `/ai-data-scientist/vs-business-analytics`, "canonicalUrl": guideData.canonicalUrl, "ogImageUrl": ogImageUrl }, { "changelog-banner": async ($$result2) => renderTemplate`${maybeRenderHead()}<div></div>`, "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "GuideContent", $$GuideContent, { "guide": guide })}  ` })}`;
}, "/workspace/src/pages/ai-data-scientist/vs-business-analytics.astro", void 0);

const $$file = "/workspace/src/pages/ai-data-scientist/vs-business-analytics.astro";
const $$url = "/ai-data-scientist/vs-business-analytics";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$VsBusinessAnalytics,
  file: $$file,
  url: $$url
