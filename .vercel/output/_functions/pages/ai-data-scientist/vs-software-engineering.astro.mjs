...
const $$VsSoftwareEngineering = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": guideData.seo.title, "description": guideData.seo.description, "permalink": `/ai-data-scientist/vs-software-engineering`, "canonicalUrl": guideData.canonicalUrl, "ogImageUrl": ogImageUrl }, { "changelog-banner": async ($$result2) => renderTemplate`${maybeRenderHead()}<div></div>`, "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "GuideContent", $$GuideContent, { "guide": guide })}  ` })}`;
}, "/workspace/src/pages/ai-data-scientist/vs-software-engineering.astro", void 0);

const $$file = "/workspace/src/pages/ai-data-scientist/vs-software-engineering.astro";
const $$url = "/ai-data-scientist/vs-software-engineering";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$VsSoftwareEngineering,
  file: $$file,
  url: $$url
