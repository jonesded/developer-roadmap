...
import { u as useOutsideClick, S as Spinner, b as getUrlParams, s as setUrlParams, d as deleteUrlParam, e as httpGet, $ as $$BaseLayout } from '../../chunks/BaseLayout_DfQviQZ5.mjs';
...
function ExploreAIRoadmap() {
  ...
  const loadAIRoadmaps = async (currPage = 1, searchTerm = "", sortBy = "createdAt") => {
    const { response, error } = await httpGet(
      `${"https://api.hnmdevs.com"}/v1-list-ai-roadmaps`,
      {
        currPage,
