...
const $$AutomationTools = createComponent(async ($$result, $$props, $$slots) => {
...
}, "/workspace/src/pages/devops/automation-tools.astro", void 0);

const $$file = "/workspace/src/pages/devops/automation-tools.astro";
const $$url = "/devops/automation-tools";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$AutomationTools,
  file: $$file,
  url: $$url
