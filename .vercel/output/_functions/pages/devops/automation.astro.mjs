...
const $$Automation = createComponent(async ($$result, $$props, $$slots) => {
...
}, "/workspace/src/pages/devops/automation.astro", void 0);

const $$file = "/workspace/src/pages/devops/automation.astro";
const $$url = "/devops/automation";
