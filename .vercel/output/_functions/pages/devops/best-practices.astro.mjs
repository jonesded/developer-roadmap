...
const $$BestPractices = createComponent(async ($$result, $$props, $$slots) => {
...
}, "/workspace/src/pages/devops/best-practices.astro", void 0);

const $$file = "/workspace/src/pages/devops/best-practices.astro";
const $$url = "/devops/best-practices";
