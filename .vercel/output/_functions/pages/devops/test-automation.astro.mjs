...
const $$TestAutomation = createComponent(async ($$result, $$props, $$slots) => {
...
}, "/workspace/src/pages/devops/test-automation.astro", void 0);

const $$file = "/workspace/src/pages/devops/test-automation.astro";
const $$url = "/devops/test-automation";
