...
const $$VsDevsecops = createComponent(async ($$result, $$props, $$slots) => {
...
}, "/workspace/src/pages/devops/vs-devsecops.astro", void 0);

const $$file = "/workspace/src/pages/devops/vs-devsecops.astro";
const $$url = "/devops/vs-devsecops";
