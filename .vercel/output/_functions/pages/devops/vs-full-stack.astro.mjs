...
const $$VsFullStack = createComponent(async ($$result, $$props, $$slots) => {
...
}, "/workspace/src/pages/devops/vs-full-stack.astro", void 0);

const $$file = "/workspace/src/pages/devops/vs-full-stack.astro";
const $$url = "/devops/vs-full-stack";
