...
}, "/workspace/src/pages/frontend/developer-skills.astro", void 0);

const $$file = "/workspace/src/pages/frontend/developer-skills.astro";
const $$url = "/frontend/developer-skills";
