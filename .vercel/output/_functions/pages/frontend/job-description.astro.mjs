...
}, "/workspace/src/pages/frontend/job-description.astro", void 0);

const $$file = "/workspace/src/pages/frontend/job-description.astro";
const $$url = "/frontend/job-description";
