...
}, "/workspace/src/pages/full-stack/job-description.astro", void 0);

const $$file = "/workspace/src/pages/full-stack/job-description.astro";
const $$url = "/full-stack/job-description";
