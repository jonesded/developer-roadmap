...
Our AI Tutor analyzes your experience, suggests relevant roadmaps,
          ...
          career.
</p> <a href="/ai/chat" class="inline-flex items-center gap-2 rounded-xl bg-black py-2 px-4 sm:px-6 sm:py-3 text-sm font-medium text-white transition-colors hover:opacity-80 sm:text-base"> ${renderComponent($$result2, "MessageCircle", MessageCircle, { "className": "size-3 sm:size-5 fill-current" })}
Chat with AI Tutor
...
}, "/workspace/src/pages/get-started.astro", void 0);

const $$file = "/workspace/src/pages/get-started.astro";
