...
const $$RestApi = createComponent(async ($$result, $$props, $$slots) => {
...
}, "/workspace/src/pages/golang/rest-api.astro", void 0);

const $$file = "/workspace/src/pages/golang/rest-api.astro";
const $$url = "/golang/rest-api";
