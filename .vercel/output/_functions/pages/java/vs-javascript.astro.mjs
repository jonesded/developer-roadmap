...
const $$VsJavascript = createComponent(async ($$result, $$props, $$slots) => {
...
}, "/workspace/src/pages/java/vs-javascript.astro", void 0);

const $$file = "/workspace/src/pages/java/vs-javascript.astro";
const $$url = "/java/vs-javascript";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$VsJavascript,
  file: $$file,
  url: $$url
